...
def manager_thread() -> None:
  ...
  ensure_running(managed_processes.values(), False, params=params, not_run=ignore)
  ...
  while True:
    ...
    ensure_running(managed_processes.values(), started, params=params, not_run=ignore)
